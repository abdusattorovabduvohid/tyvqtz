...
//
// viewport-fit=cover здесь НЕ ставим. На iPhone он растягивает вьюпорт под
// статус-бар, шапка уезжает под системную строку, и по бургеру (size="sm")
// становится невозможно попасть — тап перехватывает система. Аватар справа
// крупнее и потому ещё нажимался, из-за чего баг выглядел выборочным.
// При statusBarStyle: "default" iOS сам укладывает контент ниже статус-бара,
// так что cover ничего не даёт.
//
